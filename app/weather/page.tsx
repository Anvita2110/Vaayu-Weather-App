...
export default function WeatherPage() {
  ...
  const getAQILevel = (pm25: number) => {
    ...
    if (pm25 <= 55.4) return { level: "Unhealthy for Sensitive", color: "text-orange-600" };
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {weather && !isLoading && (
          <div className="space-y-10">
            ...
            <div className="bg-white/95 backdrop-blur-sm rounded-3xl p-8 shadow-2xl">
              <h3 className="text-2xl font-bold text-zinc-800 mb-6">Air Quality</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-[#f9f8d4] rounded-xl p-6">
                  ...
                  <div className={`text-lg font-semibold ${getAQILevel(weather.current.air_quality.pm2_5).color}`}>
